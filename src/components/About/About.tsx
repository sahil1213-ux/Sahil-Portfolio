...
import SahilAnand from "../../assets/SahilAnand.png";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! I'm Sahil, a website developer with a passion for creating
            custom online experiences for my clients. With a skill set including
            HTML, CSS, JavaScript, TailwindCSS and React, I have the tools to
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.2 * 1000}>
          <img src={SahilAnand} alt="Sahil Anand" />
        </ScrollAnimation>
      </div>
    </Container>
  );
